    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4  ">
        <a className="block w-[12rem] xl:mr-8" href="#hero">
          <img src="logo.png" width={190} height={20} alt="c4a" />
        </a>
        ...
        <a
          href="#signup"
          className="button hidden mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:block text-xl"
        >
          Sign up
        </a>
        {/* <Button className="hidden lg:flex text-xl" href="#login">
          Sign in
        </Button> */}
        {/* 
        <Button
